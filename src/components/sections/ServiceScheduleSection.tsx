  ...
  return (
    <section className="py-16 lg:py-20 bg-white dark:bg-gray-900" aria-labelledby="services-title">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header ref={headerRef} className={`text-center mb-12 lg:mb-14 transition-all duration-700 ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed font-sans">
            Join the worship, fellowship, and spiritual growth throughout the week.
          </p>
        </header>
